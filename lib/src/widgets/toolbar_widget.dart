          ...
          children: List.generate(t.getIcons().length, (index) {
            ...
            return Padding(
              padding: const EdgeInsets.symmetric(
                  horizontal: 8.0), // spacing antar tombol
              child: InkWell(
                              ...
                              child: AlertDialog(
                                ...
                                actions: <Widget>[
                                  ...
                                  TextButton(
                                      ...
                                      child:
                                          const Text('Reset to default color')),
                                  TextButton(
                                    onPressed: () {
                                      if (t.getIcons()[index].icon ==
                                          Icons.format_color_text) {
                ...
                child: Container(
                    ...
                    border: Border.all(
                      color: isSelected
                          ? widget.htmlToolbarOptions
                              ...
                              Colors.black
                          : widget.htmlToolbarOptions.buttonBorderColor ??
                              Colors.grey,
                    ),
                    borderRadius:
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Cash', style: TextStyle(fontSize: 10)), // contoh
                    ],
                  ),
                ),
              ),
